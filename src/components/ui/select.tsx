...
function SelectValue({
  ...
  return (
    <SelectPrimitive.Value
      ...
      {...props}
      className="max-w-[calc(100%-calc(var(--spacing)*6))]"
    />
  );
}
...
const selectLabelVariants = cva(
  "px-2 py-1.5 text-xs font-bold mb-1 rounded-sm",
  {
    variants: {
      variant: {
...
function SelectItem({
  ...
  return (
    ...
    >
      ...
      <span className="flex min-w-0 flex-col items-start gap-0.5 py-0.5 leading-tight">
